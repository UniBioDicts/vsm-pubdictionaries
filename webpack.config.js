/*
This Webpack-config builds a version of VsmPubDictionaries that can be
...
module.exports = () => ({
  ...
  output: {
    path: dist,
    filename: 'vsm-pubdictionaries.min.js',
    library: 'VsmPubDictionaries',
    libraryTarget: 'var'
  }
});
